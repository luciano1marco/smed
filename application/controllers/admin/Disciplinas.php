...
class disciplinas extends Admin_Controller {
    ...
    public function index(){
            if ( ! $this->ion_auth->logged_in() OR ! $this->ion_auth->is_admin())
                ...
                { /* Breadcrumbs */
                  ...
                  $this->data['disciplina']= R::findAll('disciplinas');   
    ...
    public function create() {
		/* Breadcrumbs */
		$this->breadcrumbs->unshift(2, "Nova Disciplina", 'admin/disciplinas/create');
		$this->data['breadcrumb'] = $this->breadcrumbs->show();

		/* Variables */
		$tables = $this->config->item('tables', 'ion_auth');
        /* Nome do Botão Criar do INDEX */
        $this->data['texto_create'] = 'Adicionar Disciplina';
		/* Validate form input */
    ...
    public function edit($id) {    
            ...
            /* Breadcrumbs */
            $this->breadcrumbs->unshift(2, "Editar Disciplinas", 'admin/disciplinas/edit');
            $this->data['breadcrumb'] = $this->breadcrumbs->show();
           
            $tables = $this->config->item('tables', 'ion_auth');
            /* Nome do Botão Criar do INDEX */
            $this->data['texto_edit'] = 'Editar Disciplina';
            /* Validate form input */
            $this->form_validation->set_rules('descricao', 'descricao', 'required');
