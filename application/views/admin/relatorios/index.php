					...
					<div class="box-header with-border">
						<div class="panel panel-azul">
							<div class="panel-heading">
								<h3 align="center" style="color:black">Vagas por Escola</h3>
							</div>
						</div>
					</div>
					<div class="box-body">
							...
							<tbody>
								<?php foreach ($escolas as $i) : ?>
									<tr>
										...
										<!-- Opções -->
										<td>
											<?php echo anchor($anchor . '/view/' . $i['id'],   "<button class=\"btn btn-azul btn-responsive\"><i class=\"fa fa-search\"></i>Ver</button>"); ?>&nbsp;&nbsp;
										</td>
									</tr>
								<?php endforeach; ?>
							</tbody>
