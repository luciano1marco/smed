                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <?php echo form_label('Sócio', 'nome', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-6">
                                <?php echo form_dropdown($id_socio); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php echo form_label('Cargo', 'nome', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-6">
                                <?php echo form_dropdown($id_cargo); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php echo form_label('Data de Início', 'nome', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-6">
                                <?php echo form_input($dt_inicio); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php echo form_label('Data de Término', 'nome', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-6">
