    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item">Itens de Menu de Estagio</li>
        ...
        <div class="card card-primary card-outline">
                <div class="card-header">     
                    <h3 class="card-title">Editar Itens</h3>      
...
$(document).ready(function() {
    ...
    $("#form-edit").validate({   
        ...
        messages: {
            controller: 'O campo Controlador é obrigatório.',   
            descricao:  'O campo Descrição é obrigatório.',
            icone:  'O campo Ícone é obrigatório.',      
            section:  'O campo Sessão é obrigatório.'                
        },
