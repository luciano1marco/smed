    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item">Editar Etapa</li>
        ...
        <div class="card card-primary card-outline">
                ...
                <input type="hidden" id="id" name="id" value= "<?php echo $id['id']; ?>">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="tipo">Tipo</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="dataini">Início da etapa</label>
                        <div class="col-sm-4">
                            <?php echo form_input($dataini);?>
                        </div>
                    </div>
                    <div class="form-group row"> 
                        <label class="col-sm-2 col-form-label text-right" for="datafim">Previsão para final</label>
                        <div class="col-sm-4">
                            <?php echo form_input($datafim);?>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="status">Status Atual</label>
                        <div class="col-sm-4">
    ...
    <div class="modal fade" id="modal_delete">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <button type="button" class="btn btn-danger" id="btExcluiretapa"><?php echo $delete; ?></button> 
...
$(document).ready(function() {
    ...
    $("#form-edit").validate({   
        ...
        messages: {
            ...
            dataini:'O campo Inicio da Etapa é obrigatório.',
            datafim:'O campo Previsão para Final é obrigatório.',
            status: 'O campo Status Atual é obrigatório.',
