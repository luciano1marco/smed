                        ...
                        <?php echo form_open(current_url(), array('class' => 'form', 'id' => 'form')); ?>
                            ...
                            <!--campos demonstrativo mensal -->
                                <div class="form-group">
                                    <?php echo form_label('Mes/Ano', 'mes_ano', array('class' => 'col-sm-2 control-label')); ?>
                                        <div class="col-sm-1">
                                            <?php echo form_input($mes_ano); ?>
                                        </div>
                                ...
                                <div class="form-group">  
                                    ...
                                    <?php echo form_label('Qtde Manhã', 'manha', array('class' => 'col-sm-2 control-label')); ?>
                                        <div class="col-sm-1">
                                            <?php echo form_input($manha); ?>
                                        </div>
                                    <?php echo form_label('Qtde Tarde', 'Tarde', array('class' => 'col-sm-2 control-label')); ?>
                                        <div class="col-sm-1">
                                            <?php echo form_input($tarde); ?>
                                        </div>
                                </div> 
                                <div class="form-group">  
                                    <?php echo form_label('Qtde Noite', 'noite', array('class' => 'col-sm-2 control-label')); ?>
                                        <div class="col-sm-1">
                                            <?php echo form_input($noite); ?>
                                        </div>
                                    <?php echo form_label('Qtde Integral', 'integral', array('class' => 'col-sm-2 control-label')); ?>
                                        <div class="col-sm-1">
                                            <?php echo form_input($integral); ?>
                                        </div>
                                    <?php echo form_label('Qtde EJA', 'eja', array('class' => 'col-sm-2 control-label')); ?>
                                        <div class="col-sm-1">
