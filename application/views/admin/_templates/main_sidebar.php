...
<aside class="main-sidebar">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
                    ...
                    <ul class="treeview-menu">
                        <li class="<?=active_link_function('interfaces')?>">
                            <a href="<?php echo site_url('admin/prefs/interfaces/admin'); ?>">
                                <i class="fa fa-eye"></i><?php echo lang('menu_interfaces'); ?>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <?php } ?>
            <!--Menu adicionados pelo sistema(menu que esconde os itens ----->
            <?php foreach ($itensMenu as $title => $section) { ?>
                <li class="treeview <?=active_link_controller('descricao')?>">
                    <a href="#">
            ...
            <?php }  ?>
            <!---fim menu adicionados pelo sistema---->                    
        </ul>
    </section>
</aside>
